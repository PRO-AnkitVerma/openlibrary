...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # creating dummy num_authors authors
        num_authors = 13

        for author_id in range(num_authors):
            Author.objects.create(
                first_name='Snowman',
                last_name=f'Jokes {author_id}'
            )
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self) -> None:
        # create 2 users
        test_user1 = User.objects.create_user('testuser1', password='1X<ISRUkw+tuK')
        test_user2 = User.objects.create_user('testuser2', password='2HJ1vRV0Z&3iD')
